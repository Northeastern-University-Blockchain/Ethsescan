    ...
    def fire_lasers(self, strategy, contracts=None, address=None,
        ...
        for contract in (contracts or self.contracts):
            ...
            if type(contract) == SolidityContract:
                for issue in issues:
                    # from here we get lineno  --zyx
                    issue.add_code_info(contract)
                    print(str(issue.lineno)+"it comes from mythril.py -388:")

            all_issues += issues
#       return  all_issues  --zyx
    ...
    def zyx_lasers(self, strategy, contracts=None, address=None,
                    modules=None,
                    verbose_report=False, max_depth=None, execution_timeout=None, ):
